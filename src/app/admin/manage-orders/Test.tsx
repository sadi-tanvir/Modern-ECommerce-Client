import { LeftArrowIcon, RightArrowIcon } from '@/app/components/shared/Icon';
import React, { useState } from 'react';

const Pagination = ({ items, itemsPerPage }: any) => {
    ...
    const renderPageNumbers = () => {
        ...
        for (let i = 1; i <= totalPages; i++) {
            pageNumbers.push(
                <li
                    key={i}
                    className={`${i === currentPage ? 'bg-blue-500' : 'bg-gray-200'
