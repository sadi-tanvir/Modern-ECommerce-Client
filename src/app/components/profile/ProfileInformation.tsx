        ...
        <>
            ...
            <div className="mt-6 border-t border-gray-300 pt-4">
                <div className='flex justify-between items-center'>
                    ...
                    <span onClick={() => router.push('/profile/update-password')} className='text-red-500 cursor-pointer hover:underline'>change</span>
                </div>
                ...
                <div className='flex justify-between items-center'>
                    ...
                    <span className='text-red-500 cursor-pointer hover:underline'>change</span>
                </div>
            </div>
        </>
    )
